...
const app = createApp({
  ...
  methods: {
    ...
    async fetchResourcemapVariables(params) {
      ...
      const resourcemapUrl = `https://cdi-dev.dataverse-europe.eu/api/datasets/export?exporter=resourcemap&persistentId=${persistentId}`;
      try {
    ...
    async loadJsonLdFromUrl() {
      ...
      if (params.fileid && params.siteUrl && params.datasetid && params.datasetversion && params.locale) {
        ...
        siteUrl = 'https://cdi-dev.dataverse-europe.eu';
